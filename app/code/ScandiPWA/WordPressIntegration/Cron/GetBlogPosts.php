...
namespace ScandiPWA\WordPressIntegration\Cron;
...
use ScandiPWA\WordPressIntegration\Model\ResourceModel\WordPressPost\Collection as WordPressPostCollection;
use ScandiPWA\WordPressIntegration\Model\ResourceModel\WordPressPost\CollectionFactory as WordPressPostCollectionFactory;
use ScandiPWA\WordPressIntegration\Model\WordPressPostFactory;


/**
 * This class will get blog posts for each store if it has WordPress integration settings saved
 * @package ScandiPWA\WordPressIntegration\Cron
 */
class GetBlogPosts
{
